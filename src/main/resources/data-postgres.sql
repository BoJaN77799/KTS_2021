...
values ('U', '$2a$10$L0RXf3.bj4pIw8jmzIgha..M3Cb1JRZBPV0HKCISz/btBeh3hO0Lq', 'Filip', 'Markovic',
        'admin@maildrop.cc', 'MALE', '0642312341', 'False', 'False', 'ADMINISTRATOR', null, 'Luzicka 32, Becej',
        false); --1

insert into app_user (dtype, password, first_name, last_name, email, gender, telephone, is_password_changed,
                      is_email_verified, user_type, salary, address, deleted)
values ('U', '$2a$10$ZqRoZridlWZYrJhPbIek3.xOtlG4M8cZ3aWWpBPW2IU7yreEZd8jq', 'Petar', 'Djuric',
        'manager@maildrop.cc', 'MALE', '0642312341', 'False', 'False', 'MANAGER', null, 'Luzicka 32, Trebinje',
        false); --2
...
values ('E', '$2a$10$hB5YCgeGsfGSwJZLmG3tXeTn.CrfkyksuzfcNTKgIgoL0CjBwkIcq', 'Marko', 'Kraljevic',
        'waiter_marko@maildrop.cc', 'MALE', '0642312341', 'False', 'False', 'WAITER', 4000.0, 'Luzicka 32, Livno',
        false,
...
values ('E', '$2a$10$hB5YCgeGsfGSwJZLmG3tXeTn.CrfkyksuzfcNTKgIgoL0CjBwkIcq', 'Milorad', 'Dodik',
        'waiter_milorad@maildrop.cc', 'MALE', '0642312341', 'False', 'False', 'WAITER', 7000.0, 'Luzicka 15, Laktasi',
        false,
...
values ('E', '$2a$10$nMP47GLIXnJBN24FFK79tew9Wt.uNC2tY0sDY4sDdz7gknQzkZmui', 'Igor', 'Dodik',
        'headcook_igor@maildrop.cc', 'MALE', '0642312341', 'False', 'False', 'HEAD_COOK', 10000.0,
        'Dunavska 32, Novi Sad', false,
...
values ('E', '$2a$10$nMP47GLIXnJBN24FFK79tew9Wt.uNC2tY0sDY4sDdz7gknQzkZmui', 'Drasko', 'Stanivukovic',
        'cook_drasko@maildrop.cc', 'MALE', '0642312341', 'False', 'False', 'COOK', 3000.0, 'Luzicka 32, Gradiska',
        false,
...
values ('E', '$2a$10$II8odOsKhUp4LS/cID0DFuuBFWWAcXAgdxYXtlstns6z5dxPjSRw2', 'Andrej', 'Vucic',
        'barman_andrej@maildrop.cc', 'MALE', '0642312341', 'False', 'False', 'BARMAN', 4200.0, 'Luzicka 32, Becej',
        false,
        '/user_profile_photos/test/default.jpg');
--9
...
insert into salary (amount, date_from, employee_id)
values (6500, 1635721200000, 4);
insert into salary (amount, date_from, employee_id)
values (9500, 1635721200000, 5);
insert into salary (amount, date_from, employee_id)
values (2800, 1635721200000, 6);
insert into salary (amount, date_from, employee_id)
values (3300, 1635721200000, 7);
insert into salary (amount, date_from, employee_id)
values (3800, 1635721200000, 8);
insert into salary (amount, date_from, employee_id)
values (4000, 1635721200000, 9);
-- trenutna plata 1.1.2022
insert into salary (amount, date_from, employee_id)
values (4000, 1640991600000, 3);
insert into salary (amount, date_from, employee_id)
values (7000, 1640991600000, 4);
insert into salary (amount, date_from, employee_id)
values (10000, 1640991600000, 5);
insert into salary (amount, date_from, employee_id)
values (3000, 1640991600000, 6);
insert into salary (amount, date_from, employee_id)
values (3500, 1640991600000, 7);
insert into salary (amount, date_from, employee_id)
values (4000, 1640991600000, 8);
insert into salary (amount, date_from, employee_id)
values (4200, 1640991600000, 9);

insert into bonus (amount, date_to, employee_id)
values (500, 1637190000000, 3);
insert into bonus (amount, date_to, employee_id)
values (650, 1637362800000, 3);
insert into bonus (amount, date_to, employee_id)
values (720, 1639695600000, 6);
insert into bonus (amount, date_to, employee_id)
values (300, 1640214000000, 7);

INSERT INTO USER_AUTHORITY (app_user_id, authority_id)
VALUES (1, 1); -- admin
INSERT INTO USER_AUTHORITY (app_user_id, authority_id)
VALUES (2, 2); -- menager
INSERT INTO USER_AUTHORITY (app_user_id, authority_id)
...
insert into ingredient (name, allergen)
values ('Secer', 'False'); --1
insert into ingredient (name, allergen)
values ('Mleko', 'True'); --2
insert into ingredient (name, allergen)
values ('Brasno', 'False'); --3
insert into ingredient (name, allergen)
values ('Cimet', 'True'); --4
insert into ingredient (name, allergen)
values ('Jaja', 'True'); --5
...
values ('Voda', 'False'); --6
insert into ingredient (name, allergen)
values ('Prezle', 'False'); --7
insert into ingredient (name, allergen)
values ('So', 'False'); --8
insert into ingredient (name, allergen)
values ('Gnjecene jagode', 'True'); --9
insert into ingredient (name, allergen)
values ('Jecam', 'False'); --10
insert into ingredient (name, allergen)
values ('Slad', 'True'); --11
insert into ingredient (name, allergen)
values ('Ekstrakt limuna', 'True'); --12

insert into category (name)
values ('Supe'); --1
insert into category (name)
values ('Mlecni proizvodi'); --2
insert into category (name)
values ('Mesni proizvodi'); --3
insert into category (name)
values ('Sladoledi'); --4
insert into category (name)
values ('Kolaci'); --5
...
values ('Palacinke'); --6
insert into category (name)
values ('Gazirana pica'); --7
insert into category (name)
values ('Bezalkoholna pica'); --8
insert into category (name)
values ('Alkoholna pica'); --9
insert into category (name)
values ('Kafe'); --10
...
insert into food (id, recipe, time_to_make, food_type)
values (2, 'Ma lako se pravi.', 20, 'APPETIZER'); --2
...
insert into food (id, recipe, time_to_make, food_type)
values (9, 'Treba vode i secera.', 2, 'DESERT'); --9

insert into item (name, description, image, cost, category_id, current_price, item_type, menu, deleted)
values ('Cheese-Cake', 'Kora meka napravljena od plazme.', 'putanja/kolac', 200.0, 5, 500, 'FOOD', 'Nedefinisan',
        'False');
insert into food (id, recipe, time_to_make, food_type)
values (10, 'Treba sira, malina i plazma.', 15, 'DESERT'); --10

insert into item (name, description, image, cost, category_id, current_price, item_type, menu, deleted)
values ('Ledene kocke', 'Ledno, slatko i preukusno.', 'putanja/kolac', 300.0, 5, 450, 'FOOD', 'Specijalni meni',
        'False');
insert into food (id, recipe, time_to_make, food_type)
...
insert into food (id, recipe, time_to_make, food_type)
values (13, 'Klasicna palacinka koja se napuni sa nutelom i plazmom.', 10, 'DESERT'); --13
...
insert into menu (name, active_menu)
values ('Stalni meni', 'True');
insert into menu (name, active_menu)
values ('Specijalni meni', 'True');
insert into menu (name, active_menu)
values ('Leto', 'False');
insert into menu (name, active_menu)
values ('Zima', 'False');

insert into item_ingredient (item_id, ingredient_id)
values (1, 3);
insert into item_ingredient (item_id, ingredient_id)
values (2, 2);
insert into item_ingredient (item_id, ingredient_id)
...
-- vrijedi od 1.11
insert into price (amount, date_from, item_id)
values (300.0, 1635721200000, 1);
insert into price (amount, date_from, item_id)
values (350.0, 1635721200000, 2);
insert into price (amount, date_from, item_id)
values (600.0, 1635721200000, 3);
insert into price (amount, date_from, item_id)
values (650.0, 1635721200000, 4);
insert into price (amount, date_from, item_id)
values (950.0, 1635721200000, 5);
insert into price (amount, date_from, item_id)
values (2500.0, 1635721200000, 6);
insert into price (amount, date_from, item_id)
values (960.0, 1635721200000, 7);
insert into price (amount, date_from, item_id)
values (240.0, 1635721200000, 8);
insert into price (amount, date_from, item_id)
values (200.0, 1635721200000, 9);
insert into price (amount, date_from, item_id)
values (500.0, 1635721200000, 10);
insert into price (amount, date_from, item_id)
values (450.0, 1635721200000, 11);
insert into price (amount, date_from, item_id)
values (500.0, 1635721200000, 12);
insert into price (amount, date_from, item_id)
values (400.0, 1635721200000, 13);
insert into price (amount, date_from, item_id)
values (200.0, 1635721200000, 14);
insert into price (amount, date_from, item_id)
values (180.0, 1635721200000, 15);
insert into price (amount, date_from, item_id)
values (220.0, 1635721200000, 16);
insert into price (amount, date_from, item_id)
values (180.0, 1635721200000, 17);
insert into price (amount, date_from, item_id)
values (200.0, 1635721200000, 18);
insert into price (amount, date_from, item_id)
values (220.0, 1635721200000, 19);
insert into price (amount, date_from, item_id)
values (200.0, 1635721200000, 20);
insert into price (amount, date_from, item_id)
values (240.0, 1635721200000, 21);

insert into tables (active, x, y, floor)
values (true, 53, 53, 0);
insert into tables (active, x, y, floor)
values (true, 161, 56, 0);
insert into tables (active, x, y, floor)
values (true, 272, 66, 0);
insert into tables (active, x, y, floor)
values (true, 397, 70, 0);
insert into tables (active, x, y, floor)
values (true, 508, 70, 0);
insert into tables (active, x, y, floor)
values (true, 52, 276, 0);
insert into tables (active, x, y, floor)
values (true, 163, 281, 0);
insert into tables (active, x, y, floor)
values (true, 283, 297, 0);
insert into tables (active, x, y, floor)
values (true, 396, 305, 0);
insert into tables (active, x, y, floor)
values (true, 504, 243, 0);
insert into tables (active, x, y, floor)
values (true, 53, 53, 1);
insert into tables (active, x, y, floor)
values (true, 161, 56, 1);
insert into tables (active, x, y, floor)
values (true, 272, 66, 1);
insert into tables (active, x, y, floor)
values (true, 397, 70, 1);
...
insert into order_item (quantity, status, price, priority, order_id, item_id)
values (2, 'DELIVERED', 200.0, 0, 4, 14);
--cola 100
...
insert into order_item (quantity, status, price, priority, order_id, item_id)
values (5, 'DELIVERED', 200.0, 0, 8, 14);
--cola 100
...
insert into order_item (quantity, status, price, priority, order_id, item_id)
values (4, 'DELIVERED', 400.0, 2, 10, 13);
--palacinke slatke 200
...
insert into restaurant_order (status, created_at, note, table_id, waiter_id)
values ('NEW', 1643216540339, 'Molim vas da ne presolite, smeta mi so.', 2, 4);
insert into order_item (quantity, status, price, priority, order_id, item_id)
values (1, 'ORDERED', 300.0, 1, 13, 1); --govednja supa 250
insert into order_item (quantity, status, price, priority, order_id, item_id)
values (3, 'ORDERED', 350.0, 1, 13, 2); --pileca supa 300
insert into order_item (quantity, status, price, priority, order_id, item_id)
values (2, 'ORDERED', 2500.0, 2, 13, 6); --jagnjece pecenje 2000
...
insert into order_item (quantity, status, price, priority, order_id, item_id)
values (4, 'ORDERED', 350.0, 1, 15, 2); --pileca supa 300
insert into order_item (quantity, status, price, priority, order_id, item_id)
values (1, 'ORDERED', 2500.0, 2, 15, 6);
--jagnjece pecenje 2000
