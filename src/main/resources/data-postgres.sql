...
insert into restaurant_order (status, created_at, note, table_id, waiter_id) values ('FINISHED', 1636930800000, 'Pozuri, galdan sam.', 1, 3);
...
insert into restaurant_order (status, created_at, note, table_id, waiter_id) values ('FINISHED', 1636844400000, 'Pozuri, zedan sam.', 3, 3);
