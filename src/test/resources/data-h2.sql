...
values ('Supa', 'Bas je Slana', 'putanja/supa', 250.0, 1, 300, 'FOOD', 'Stalni meni', 'False');
insert into food (id, recipe, time_to_make, food_type) values (1, 'Ma lako se pravi', 20, 'APPETIZER');

insert into item (name, description, image, cost, category_id, current_price, item_type, menu, deleted)
values ('Pohovani kackavalj', 'I on je slan', 'putanja/kackavalj', 550.0, 3, 600, 'FOOD', 'Stalni meni', 'False');
insert into food (id, recipe, time_to_make, food_type) values (2, 'Brzo se pravi', 15, 'APPETIZER');

insert into item (name, description, image, cost, category_id, current_price, item_type, menu, deleted)
values ('Prsuta', 'Bas je mnogo slana', 'putanja/prsuta', 750.0, 5, 950, 'FOOD', 'Stalni meni',  'False');
insert into food (id, recipe, time_to_make, food_type) values (3, 'Ma tesko se pravi', 5, 'APPETIZER');

insert into item (name, description, image, cost, category_id, current_price, item_type, menu, deleted)
values ('Jagnjece pecenje', 'Bas je ultra Slana', 'putanja/mmm', 2000.0, 5, 2500, 'FOOD', 'Stalni meni', 'False');
insert into food (id, recipe, time_to_make, food_type) values (4, 'Ma lako se pravi', 120, 'MAIN_DISH');

insert into item (name, description, image, cost, category_id, current_price, item_type, menu, deleted)
values ('Pileca krilca', 'Nisu losa', 'putanja/krila', 850.0, 4, 960, 'FOOD', 'Stalni meni', 'False');
insert into food (id, recipe, time_to_make, food_type) values (5, 'Ma lako se pravi', 30, 'MAIN_DISH');

insert into item (name, description, image, cost, category_id, current_price, item_type, menu, deleted)
values ('Sladoled Kapri', 'Zaledjen', 'putanja/sladoled', 150.0, 6, 240, 'FOOD', 'Specijalni meni', 'False');
insert into food (id, recipe, time_to_make, food_type) values (6, 'Ma lako se pravi', 2, 'DESERT');

insert into item (name, description, image, cost, category_id, current_price, item_type, menu, deleted)
values ('Coca Cola', 'Bas je gazirana', 'putanja/cola', 140.0, 2, 160, 'DRINK', 'Specijalni meni', 'False');
insert into drink (id, volume ) values (7, 0.5);

insert into item (name, description, image, cost, category_id, current_price, item_type, menu, deleted)
values ('Niksicko pivo', 'Osvezavajuce', 'putanja/vopi', 110.0, 7, 140, 'DRINK', 'Leto', 'False');
insert into drink (id, volume ) values (8, 0.5);

insert into item (name, description, image, cost, category_id, current_price, item_type, menu, deleted)
values ('Zajecarsko pivo', 'Vise osvezavajuce nego Niksicko', 'putanja/vopiza', 120.0, 7, 150, 'DRINK', 'Nedefinisan', 'False');
...
insert into tables (active, x, y, floor) values (false, 32, 10, 1);
insert into tables (id, active, x, y, floor) values (120, true, 6.0, 6.0, 0);
insert into tables (id, active, x, y, floor) values (121, true, 7.0, 7.0, 0);
...
insert into restaurant_order (status, created_at, note, table_id, waiter_id, barman_id) values ('IN_PROGRESS', 1636730076405, 'Pozuri, gladan i zedan sam.',4, 3, 5);
...
insert into restaurant_order (status, created_at, note, table_id, waiter_id, barman_id, cook_id) values ('IN_PROGRESS', 1636730076405, 'Pozuri gladan sam.', 5, 3, 5, 4);
...
insert into restaurant_order (status, created_at, note, table_id, waiter_id, barman_id) values ('FINISHED', 1636730076405, 'Pozuri, gladan i zedan sam.', 6, 3, 5);
...
insert into restaurant_order (status, created_at, note, table_id, waiter_id, barman_id, cook_id) values ('FINISHED', 1636730076405, 'Pozuri gladan sam.', 6, 3, 5, 4);
...
insert into restaurant_order (status, created_at, note, table_id, waiter_id, cook_id) values ('FINISHED', 1636730076405, 'Pozuri, gladan i zedan sam.', 7, 3, 4);
...
insert into restaurant_order (status, created_at, note, table_id, waiter_id, barman_id, cook_id) values ('FINISHED', 1636730076405, 'Pozuri gladan sam.', 7, 3, 5, 4);
...
insert into restaurant_order (status, created_at, note, table_id, waiter_id, profit) values ('FINISHED', 1636930800000, 'Pozuri, galdan sam.', 8, 3, 200);
...
insert into restaurant_order (status, created_at, note, table_id, waiter_id, profit) values ('FINISHED', 1636844400000, 'Pozuri, zedan sam.', 8, 3, 200);
...
insert into restaurant_order (status, created_at, note, table_id, waiter_id, barman_id, cook_id) values ('IN_PROGRESS', 1636730076405, 'Probam izmenu porudzbine.', 9, 3, 6, 4);
